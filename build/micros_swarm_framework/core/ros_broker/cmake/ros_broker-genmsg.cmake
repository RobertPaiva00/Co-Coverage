...
set(MSG_I_FLAGS "-Iros_broker:/home/roberto/COverage_ws/src/micros_swarm_framework/core/ros_broker/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/roberto/COverage_ws/src/micros_swarm_framework/core/ros_broker/msg/GSDFPacket.msg" NAME_WE)
add_custom_target(_ros_broker_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_broker" "/home/roberto/COverage_ws/src/micros_swarm_framework/core/ros_broker/msg/GSDFPacket.msg" ""
)
...
_generate_msg_cpp(ros_broker
  "/home/roberto/COverage_ws/src/micros_swarm_framework/core/ros_broker/msg/GSDFPacket.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_broker)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_broker\")")
  # install generated code
  install(
