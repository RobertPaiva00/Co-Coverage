...
if("TRUE" STREQUAL "TRUE")
  set(app_loader_SOURCE_PREFIX /home/roberto/COverage_ws/src/micros_swarm_framework/core/app_loader)
  set(app_loader_DEVEL_PREFIX /home/roberto/COverage_ws/devel)
  ...
  set(app_loader_INSTALL_PREFIX /home/roberto/COverage_ws/install)
...
if(NOT "/home/roberto/COverage_ws/devel/include;/home/roberto/COverage_ws/src/micros_swarm_framework/core/app_loader/include " STREQUAL " ")
  set(app_loader_INCLUDE_DIRS "")
  set(_include_dirs "/home/roberto/COverage_ws/devel/include;/home/roberto/COverage_ws/src/micros_swarm_framework/core/app_loader/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'app_loader' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roberto/COverage_ws/src/micros_swarm_framework/core/app_loader/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT app_loader_NUM_DUMMY_TARGETS)
      set(app_loader_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::app_loader::wrapped-linker-option${app_loader_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR app_loader_NUM_DUMMY_TARGETS "${app_loader_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::app_loader::wrapped-linker-option${app_loader_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND app_loader_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(app_loader_EXPORTED_TARGETS ${${app_loader_dep}_EXPORTED_TARGETS})
endforeach()
