...
if("TRUE" STREQUAL "TRUE")
  set(testvstig_SOURCE_PREFIX /home/roberto/COverage_ws/src/micros_swarm_framework/tests/testvstig)
  set(testvstig_DEVEL_PREFIX /home/roberto/COverage_ws/devel)
  ...
  set(testvstig_INSTALL_PREFIX /home/roberto/COverage_ws/install)
...
if(NOT "/home/roberto/COverage_ws/src/micros_swarm_framework/tests/testvstig/include " STREQUAL " ")
  set(testvstig_INCLUDE_DIRS "")
  set(_include_dirs "/home/roberto/COverage_ws/src/micros_swarm_framework/tests/testvstig/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'testvstig' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roberto/COverage_ws/src/micros_swarm_framework/tests/testvstig/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT testvstig_NUM_DUMMY_TARGETS)
      set(testvstig_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::testvstig::wrapped-linker-option${testvstig_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR testvstig_NUM_DUMMY_TARGETS "${testvstig_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::testvstig::wrapped-linker-option${testvstig_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND testvstig_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(testvstig_EXPORTED_TARGETS ${${testvstig_dep}_EXPORTED_TARGETS})
endforeach()
