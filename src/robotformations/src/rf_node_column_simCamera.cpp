/**
* rf_node_column_simCamera
*
* This node can be used to perform column formations in Stage, with camera constraints as FOV.
* This node applies the algorithm developed by Sérgio Monteiro in his PhD Thesis for column shapes.
...
int main(int argc, char** argv){
	double INlid, INlambda, INtau_delta, INcvrep, INcvatt;
	...
	target.setup(INlid, INlambda, INtau_delta);
